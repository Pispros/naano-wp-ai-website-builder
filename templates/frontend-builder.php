           ...
           "naano-ai-website-builder",
					...
					<div class="naano-drawer__field">
						<button type="button" class="naano-btn-secondary" id="naano-inspect-toggle-btn"
							title="<?php esc_attr_e(
           "Click any element in the preview to edit its text, style, spacing or CSS classes directly — no AI needed.",
           "naano-ai-website-builder",
       ); ?>">
							<span class="dashicons dashicons-edit"></span>
							<?php esc_html_e("Edit content manually", "naano-ai-website-builder"); ?>
						</button>
						<p class="naano-field-help">
							<?php esc_html_e(
           "When active, click an element to edit its text, styles, margins, paddings, font, and CSS classes directly. To regenerate a whole section with AI, pick it from the sections list above.",
           "naano-ai-website-builder",
       ); ?>
						</p>
					</div>
