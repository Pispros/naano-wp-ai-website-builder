...
class Naano_LLM_Router {
	 ...
	 */
	public function __construct( string $provider, string $api_key, array $options = [] ) {
	 ...
	 */
	public function generate( string $system_prompt, array $messages, array $images = [] ): string {
	 ...
	 * @throws InvalidArgumentException For unknown providers.
	 */
	private function create_adapter( string $provider, string $api_key, array $options ): Naano_LLM_Provider_Interface {
		$model = $options['model'] ?? '';
